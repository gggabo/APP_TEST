package com.apptest.application.views.dashboard1;
...
import com.vaadin.flow.router.Route;import com.apptest.application.views.main.MainView;


@Route(value = "dashboard1", layout = MainView.class)
@PageTitle("Dashboard1")
@CssImport(value = "styles/views/dashboard1/dashboard1-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class Dashboard1View extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public Dashboard1View() {
        setId("dashboard1-view");
