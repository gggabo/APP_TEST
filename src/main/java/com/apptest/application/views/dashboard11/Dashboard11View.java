package com.apptest.application.views.dashboard11;
...
@Route(value = "dashboard11", layout = MainView.class)
@PageTitle("Dashboard11")
@CssImport("styles/views/dashboard11/dashboard11-view.css")
public class Dashboard11View extends Div implements AfterNavigationObserver {
    ...
    public Dashboard11View() {
        service = new BackendService();
        setId("dashboard11-view");
        // Configure Grid
        employees = new Grid<>();
