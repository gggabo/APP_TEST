...
import $css_0 from 'Frontend/styles/views/dashboard11/dashboard11-view.css';
...
import $css_2 from 'Frontend/styles/views/dashboard1/dashboard1-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles/views/masterdetail/master-detail-view.css';
